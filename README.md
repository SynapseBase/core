...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [SynapseBase](https://github.com/SynapseBase) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for SynapseBase.
...
```bash
git clone https://github.com/SynapseBase/core
cd core
go mod download
```
